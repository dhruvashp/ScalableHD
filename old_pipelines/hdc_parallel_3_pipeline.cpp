...
// Hyperparams
int N = 2048;                              // Variable                                           Batch size, # inputs processed at once
int n = 32, f = 32, d = 32;              // GUIDANCE: Obvious                                  Chunk sizes, NOTE: k not defined and not used (chunk along classes) 
...
int main() {
    ...
    cout << "Speedup: " << avg_time_naive / avg_time_parallel << "\n";
