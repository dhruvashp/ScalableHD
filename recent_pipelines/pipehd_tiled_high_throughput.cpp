...
std::string metadata = "high_throughput__use_binding_" + std::string(USE_BIND ? "true" : "false");       
...
int main(){
    ...
    // [<mod>]    
    std::vector<int> N_vals = {1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072};        
    
    // [<mod>] 
    std::vector<int> nfdk_vals = {4, 8, 16, 32};    // n = f = d = k                  

    // [<mod>]
    std::vector<int> R_vals = {4, 8, 16, 32};                // Fixed for simplicity
