...
// Large N version (codenamed high-throughput)
...
int F = 784, D = 10000, K = 100;       

// HyperParameters
int N = 32768;                                                   // Variable                                           Batch size, # inputs processed at once
...
// MatrixXfRowMajor S_tiled;                    // Testing the tiled variant (no longer needed)
...
int main() {
    ...
    // print_matrix(Y_pred_omp, "Y_pred_omp");
    // print_matrix(Y_pred_parallel, "Y_pred_parallel");
    // print_matrix(Y_pred_tiled, "Y_pred_tiled");
    ...
    // cout << "Tiled vs OpenMP: " << avg_time_omp / avg_time_tiled << "                   (>1 Win, =1 Tie, <1 Lose) \n";   
